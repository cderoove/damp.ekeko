...
/*
 * This class is a copy of the one of SOOT. Except that it doesn't call  PackManager.v().writeOutput(); such that no Jimple Bodies are released. 
 * TODO: subclass PackManager, install another singleton instance in G.

 */

/** SootMain class for Soot; provides Soot's command-line user interface. */
public class EkekoSootMain {
    ...
    public final String versionString = Main.class.getPackage().getImplementationVersion() == null ? "trunk" : EkekoSootMain.class.getPackage().getImplementationVersion();
